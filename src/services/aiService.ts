...
// The helper keeps the TypeScript source and the preloaded script tags in sync and
// falls back to the default defined within runtimeGlobals if none is provided.
